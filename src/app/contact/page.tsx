    ...
    <div className="min-h-screen pt-24 pb-16 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-14">
          ...
          <h1 className="font-display text-7xl gradient-skull">
            TALK TO THE DEAD
          </h1>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
          ...
          <div className="bg-skull-dark rounded-2xl border border-skull-border card-glow p-8">
            {success ? (
              <div className="flex flex-col items-center justify-center h-full min-h-[400px] text-center gap-6">
                ...
                <h2 className="font-display text-3xl text-skull-text">
                  MESSAGE RECEIVED
                </h2>
                <p className="text-skull-muted max-w-xs">
                  The dead have heard you. We&apos;ll get back to you within 24
                  hours. Keep the neon burning.
                </p>
                <button
                  onClick={() => {
                    setSuccess(false);
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-5">
                <h2 className="font-display text-2xl text-skull-text mb-2">
                  DROP US A LINE
                </h2>

                <div>
                  <label className="text-skull-muted text-xs uppercase tracking-widest block mb-2">
                    Name
                  </label>
                  <input
                    type="text"
          ...
          <div className="flex flex-col gap-5">
            {[
              ...
              <div
                key={card.title}
                className="bg-skull-dark rounded-2xl border border-skull-border card-glow p-6 flex gap-4 items-start"
              >
                <div className="w-10 h-10 rounded-xl bg-skull-card flex items-center justify-center shrink-0">
                  {card.icon}
                </div>
                <div>
                  <p className="text-skull-muted text-xs uppercase tracking-widest mb-1">
                    {card.title}
                  </p>
            ...
            <div className="bg-skull-dark rounded-2xl border border-skull-border card-glow p-6">
              <p className="text-skull-muted text-xs uppercase tracking-widest mb-5">
                Find us on
              </p>
                ...
                {[
                  {
                    ...
                    label: "X / Twitter",
                    handle: "@skulldrop_gg",
                    color: "text-skull-neon-blue",
                  },
                  {
                    icon: <Camera className="w-5 h-5" />,
                    label: "Instagram",
                    handle: "@skulldrop",
                    color: "text-skull-neon-pink",
                  },
                  {
                    icon: <MessageCircle className="w-5 h-5" />,
                    label: "Discord",
                    handle: "discord.gg/skulldrop",
                    color: "text-skull-neon-purple",
                  },
                ].map((social) => (
                  <a
                    key={social.label}
                  ...
                  >
                    {social.icon}
                    <div>
                      <div className="text-sm font-medium text-skull-text">
                        {social.label}
                      </div>
                      <div className="text-xs text-skull-muted">
                        {social.handle}
                      </div>
                    </div>
                  </a>
