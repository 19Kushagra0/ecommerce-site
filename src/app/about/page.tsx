    ...
    <div className="min-h-screen pt-24 pb-16 px-4">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="text-center mb-20">
          <p className="text-skull-neon-pink text-xs uppercase tracking-[0.35em] mb-3">
            Our story
          </p>
          <h1 className="font-display text-7xl gradient-skull mb-6">
            THE ALTAR
          </h1>
          ...
          <div className="max-w-2xl mx-auto bg-skull-dark rounded-2xl border border-skull-border card-glow p-8">
            <p className="text-skull-text text-lg leading-relaxed">
              ...
              was born from late-night sessions, neon screens, and a love for
              the dead. Every product is a offering — to the culture, to the
              craft, to the grind.
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {values.map((val) => (
              ...
              >
                ...
                <p className="text-skull-muted text-sm leading-relaxed">
                  {val.description}
                </p>
              </div>
            ))}
        ...
        <section className="bg-skull-dark rounded-2xl border border-skull-border card-glow p-8 md:p-12">
          <h2 className="font-display text-3xl gradient-skull mb-8 text-center">
            FOUNDERS NOTE
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div className="flex flex-col items-center text-center md:items-start md:text-left">
              ...
              <p className="text-skull-muted text-sm">
                Est. 2024 — Born at 3AM
              </p>
            </div>
            <div>
              <blockquote className="text-skull-text text-base leading-relaxed italic border-l-2 border-skull-neon-pink pl-6">
                &quot;We started this because we were tired of gaming gear that
                looked like it was designed in a corporate boardroom. We wanted
                something that felt like us — dark, artistic, alive. Something
                that honored the dead and celebrated the grind. That&apos;s
