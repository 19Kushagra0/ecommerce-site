    ...
    <footer className="bg-skull-dark border-t border-skull-border mt-auto">
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="font-display text-2xl gradient-skull">
                SKULLDROP
              </span>
            </div>
            <p className="text-skull-muted text-sm leading-relaxed max-w-xs">
              Born from late-night sessions, neon screens, and a love for the
              dead. Premium gaming lifestyle gear for those who play until dawn.
            </p>
            <div className="flex items-center gap-4 mt-6">
              <a
                href="#"
                aria-label="Twitter/X"
                className="text-skull-muted hover:text-skull-neon-pink transition-colors duration-200"
              >
              ...
              <a
                href="#"
                aria-label="Discord"
                className="text-skull-muted hover:text-skull-neon-purple transition-colors duration-200"
              >
            ...
            <ul className="space-y-2">
              {[
                ...
                <li key={link.href}>
                  <Link
                    href={link.href}
                    className="text-skull-muted text-sm hover:text-skull-neon-pink transition-colors duration-200"
                  >
                    {link.label}
                  </Link>
                </li>
        ...
        <div className="mt-10 pt-6 border-t border-skull-border flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-skull-muted text-xs">
            © 2025 SkullDrop. All rights reserved.
          </p>
